...
<div class="card">
	...
	<div class="card-body">
	 <!--tabela-->
	  ...
	  <!--tabela-->
		<form method="post">
			<button type="submit" class="btn btn-success" name="export" formaction="<?=base_url('supervisor/extrairReprovados');?>">Download</button>	
		</form>	
			   <!-- Paginate -->
	   <div id='reprovados' class="mt-2"></div>	
...
?>	 
   ...
   <script type='text/javascript'>
	   $(document).ready(function(){
		 ...
		 $('#reprovados').on('click','a',function(e){
		   e.preventDefault(); 
		 ...
		 function loadPagination(pagno){
		   $.ajax({
			 url: '<?=base_url('supervisor/paginacaoReprovados/');?>'+pagno,
			 type: 'get',
			 dataType: 'json',
			 success: function(response){
				$('#reprovados').html(response.pagination);

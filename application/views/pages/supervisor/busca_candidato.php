      ...
      <table class="table table-bordered table-hover">
        ...
        <tbody>
          <tr>
			...
			<?php if(!file_exists('./uploads/'.$pessoa->id_funcionario.'.pdf') && !file_exists('./uploads/'.$pessoa->id_funcionario.'.docx')){ ; ?>
			<form class="btn">
			...
			<?php }else{ ;?>
				...
				<form class="btn">
              <a href="<?=base_url("./uploads/$pessoa->id_funcionario.pdf");?>" target="a_blank" class="btn btn-primary btn-sm"><i class="fas fa-download"></i> Baixar CV</a> 
				</form>
				<?php }else{ ;?>
				<form class="btn">
              <a href="<?=base_url("./uploads/$pessoa->id_funcionario.docx");?>" target="a_blank" class="btn btn-primary btn-sm"><i class="fas fa-download"></i> Baixar CV</a> 
				</form>
				<?php } ;?>
			<?php }; ?>				
            </td>

...
<div class="card">
	...
	<div class="card-body">
	 <!--tabela-->
	  ...
	  <!--tabela-->
		<form method="post">
			<button type="submit" class="btn btn-success" name="export" formaction="<?=base_url('gerente/extrairAprovados');?>">Download</button>	
		</form>	
			   <!-- Paginate -->
   ...
   <script type='text/javascript'>
	   $(document).ready(function(){
		 ...
		 function loadPagination(pagno){
		   $.ajax({
			 url: '<?=base_url('gerente/paginacaoAprovados/');?>'+pagno,
			 type: 'get',
			 dataType: 'json',

	...
	<div class="d-flex" id="wrapper">
		...
		<div class="border-right bg-light " id="sidebar-wrapper">
			...
			<div class="list-group list-group-flush">
				...
				<a href="<?=base_url("funcionarios/vagasabertas");?>" class="list-group-item list-group-item-action bg-light"><i
						style="color: Dodgerblue;" class="fas fa-calendar-alt fa-lg"></i>Vagas Abertas</a>
				<a href="<?=base_url("funcionarios/contracheques");?>" class="list-group-item list-group-item-action bg-light"><i
						style="color: Mediumslateblue;" class="far fa-list-alt fa-lg"></i>Contra cheque</a>
				<a href="<?=base_url("funcionarios/ferias");?>" class="list-group-item list-group-item-action bg-light"><i style="color: chocolate;"
						class="fas fa-calendar-check fa-lg"></i>Férias</a>
				...
				<div class="col-2 collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav ml-auto mt-2 mt-lg-0">
						<li class="nav-item dropdown">
							<a class="nav-link dropdown-toggle text-success" id="navbarDropdown" role="button"
								data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Olá Usuário</a>
